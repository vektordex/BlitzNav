...
BlitzNav is a navigation and movement helper library for Blitz3D projects.
It provides simple node-based navigation, entity alignment utilities, and movement helpers designed for games and simulations.
...
Demo scene simulations

NPC systems

RTS-style movement

Twitch-interactive crowd simulations
